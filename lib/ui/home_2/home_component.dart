                                ...
                                Expanded(
                                  ...
                                  child: SizedBox.expand(
                                    child: ListView(
                                      ...
                                      children: <Widget>[
                                        SlidableListItem(child: EventListItem(title: "Test", date: "test", subtitle: "Test deskripsi", eventIcon: Icons.alarm), onMarkAsReadButtonClicked: this.widget.presenter.onMarkAsReadButtonClicked, onDeleteButtonClicked: this.widget.presenter.onDeleteButtonClicked),
                                        SizedBox(width: 15),
